      ...
      <div class="column lg-12 s-intro__content-inner grid-block">
        ...
        <div class="s-intro__content-media">
          <div class="s-intro__content-media-inner">
            <img src="<?php echo e(url('assets/images/avater.jpg')); ?>"
              srcset="<?php echo e(url('assets/images/avater.jpg')); ?> 1x, <?php echo e(url('assets/images/intro-bg@2x.jpg')); ?> 2x"
              alt="">
            <div class="lines">
              <span></span>
            </div>
  ...
  <section id="about" class="s-about target-section">
    ...
    <div class="row s-about__content width-sixteen-col">
      <div class="column grid-block grid-section-split">
        ...
        <img src="<?php echo e(url('assets/images/geometric_shape.svg')); ?>" alt="" class="s-about__content-imgbg">
      ...
      <div class="column xl-12">
        ...
        <div class="clients-list">
          <div class="clients-list__item">
            <a href="#0">
              <img src="<?php echo e(url('assets/images/clients/flash.svg')); ?>" alt="">
            </a>
          </div>
          <div class="clients-list__item">
            <a href="#0">
              <img src="<?php echo e(url('assets/images/clients/rise.svg')); ?>" alt="">
            </a>
          </div>
          <div class="clients-list__item">
            <a href="#0">
              <img src="<?php echo e(url('assets/images/clients/cactus.svg')); ?>" alt="">
            </a>
          </div>
          <div class="clients-list__item">
            <a href="#0">
              <img src="<?php echo e(url('assets/images/clients/pinpoint.svg')); ?>" alt="">
            </a>
          </div>
          <div class="clients-list__item">
            <a href="#0">
              <img src="<?php echo e(url('assets/images/clients/proline.svg')); ?>" alt="">
            </a>
          </div>
          <div class="clients-list__item">
            <a href="#0">
              <img src="<?php echo e(url('assets/images/clients/vision.svg')); ?>" alt="">
            </a>
          </div>
          <div class="column clients-list__item">
            <a href="#0">
              <img src="<?php echo e(url('assets/images/clients/volume.svg')); ?>" alt="">
            </a>
          </div>
          <div class="column clients-list__item">
            <a href="#0">
              <img src="<?php echo e(url('assets/images/clients/hitech.svg')); ?>" alt="">
            </a>
          </div>
          <div class="clients-list__item">
            <a href="#0">
              <img src="<?php echo e(url('assets/images/clients/terra.svg')); ?>" alt="">
            </a>
          </div>
          <div class="clients-list__item">
            <a href="#0">
              <img src="<?php echo e(url('assets/images/clients/chain.svg')); ?>" alt="">
            </a>
          </div>
          ...
          <div class="swiper-wrapper">
            <div class="testimonials__slide swiper-slide">
              ...
              <div class="testimonials__author">
                <img src="<?php echo e(url('assets/images/avatars/user-01.jpg')); ?>" alt="Author image"
            ...
            <div class="testimonials__slide swiper-slide">
              ...
              <div class="testimonials__author">
                <img src="<?php echo e(url('assets/images/avatars/user-04.jpg')); ?>" alt="Author image"
                  class="testimonials__avatar">
                <cite class="testimonials__cite">
            ...
            <div class="testimonials__slide swiper-slide">
              ...
              <div class="testimonials__author">
                <img src="<?php echo e(url('assets/images/avatars/user-06.jpg')); ?>" alt="Author image"
                  class="testimonials__avatar">
                <cite class="testimonials__cite">
            ...
            <div class="testimonials__slide swiper-slide">
              ...
              <div class="testimonials__author">
                <img src="<?php echo e(url('assets/images/avatars/user-02.jpg')); ?>" alt="Author image"
                  class="testimonials__avatar">
                <cite class="testimonials__cite">
...
<?php echo $__env->make('pages.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Static_portfoliio_site\portfolio_site\resources\views/pages/index.blade.php ENDPATH**/ ?>